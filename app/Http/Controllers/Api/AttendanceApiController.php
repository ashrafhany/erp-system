...
class AttendanceApiController extends BaseApiController
{
    ...
    public function checkIn(Employee $employee): JsonResponse
    {
        try {
            ...
            return $this->errorResponse('Failed to check in employee: ' . $e->getMessage(), 500);
        }
    }
    ...
    public function checkOut(Employee $employee): JsonResponse
    {
        try {
            ...
            return $this->errorResponse('Failed to check out employee: ' . $e->getMessage(), 500);
        }
    }
    ...
    public function dailyReport(Request $request): JsonResponse
    {
        try {
            ...
            return $this->errorResponse('Failed to generate daily report: ' . $e->getMessage(), 500);
        }
    }
